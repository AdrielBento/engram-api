...
- If `mise` didn't found the correct version of Elixir or Erlang/OTP, downgrade the version or change the version until it works
...
## Testing guidelines
- Use `ExUnit` for unit tests and `Phoenix.ConnTest` for controller tests
- Mock external dependencies using libraries like `Mox` when necessary
